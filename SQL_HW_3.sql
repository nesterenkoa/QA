...
join salary_2 on employee_salary.salary_id = salary_2.id
...
join salary_2 on
employee_salary.salary_id = salary_2.id
...
join roles_2
on roles_2.id=roles_employee.role_id 
...
join salary_2 
on employee_salary.salary_id = salary_2.id 
...
select monthly_salary, role_name  from salary_2 
join  employee_salary
on  employee_salary.salary_id = salary_2.id 
join roles_employee
on roles_employee.role_id = salary_2.id
join roles_2 
on  roles_2.id =roles_employee.role_id
where role_name like '%Java%developer%'
...
on employee_salary.salary_id = salary_2.id 
join roles_employee
on roles_employee.employee_id = salary_2.id 
join roles_2 
on roles_employee.role_id = roles_2.id 
...
select avg(monthly_salary)  from salary_2 
--select monthly_salary, role_name from salary_2
join employee_salary 
on employee_salary.salary_id  = salary_2.id 
join roles_employee
...
select sum(monthly_salary) from salary_2 
join employee_salary 
on employee_salary.salary_id  = salary_2.id 
join roles_employee
on roles_employee.employee_id = salary_2.id 
...
select min(monthly_salary) from salary_2 
join employee_salary 
on employee_salary.salary_id  = salary_2.id 
join roles_employee
on roles_employee.employee_id = salary_2.id 
...
select max(monthly_salary) from salary_2 
join employee_salary 
on employee_salary.salary_id  = salary_2.id 
join roles_employee
on roles_employee.employee_id = salary_2.id 
...
select count(role_name) from roles_2 
join roles_employee
on roles_employee.role_id = roles_2.id 
where role_name like '%QA%engineer%' 
...
on roles_employee.role_id = salary_2.id 
join roles_2 
on roles_employee.employee_id = roles_2.id
where role_name like '%developer%'
